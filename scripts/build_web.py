...
const GRAMMAR_ZH = {q_ma:"吗 疑问", q_ne:"呢 疑问", q_word:"疑问词(什么/谁/哪…)", ba:"吧 建议",
  ...
  de2:"得 补语", rang:"让 兼语", wei:"为", xiang4:"向", cai:"才", gang:"刚/刚刚", geng:"更",
  yizhi:"一直", yiding:"一定", bixu:"必须", yijing:"已经", yue:"越…越/越来越", ziji:"自己",
  li2:"离", zhe:"着 持续", xiang4b:"像/好像", yinggai:"应该", keneng:"可能/也许",
  ruguo:"如果…的话", yinwei:"因为…所以", suiran:"虽然…但是", budan:"不但…而且",
  huozhe:"或者", ranhou:"然后/接着", zhiyao:"只要…就", jiuyao:"就要/快要…了",
  changchang:"经常/常常", chengdu:"程度副词(特别/非常…)", guo_exp:"过 经历"};
